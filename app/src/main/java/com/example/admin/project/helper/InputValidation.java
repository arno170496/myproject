package com.example.admin.project.helper;
...
public class InputValidation {
    ...
    public boolean isInputEditTextEmail(TextInputEditText textInputEditText,TextInputLayout textInputLayout,String messsage)
    {
        String value=textInputEditText.getText().toString().trim();
        if(value.isEmpty() || !Patterns.EMAIL_ADDRESS.matcher(value).matches())
        {
            textInputLayout.setError(messsage);
            hideKeyboardFrom(textInputEditText);
            return false;
        }
        else
